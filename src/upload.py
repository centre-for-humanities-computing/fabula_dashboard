...
app.layout = html.Div(
    children = [
        ...
        dcc.Dropdown(['English', 'Danish'], id='lang-dropdown', placeholder="Select a lagnguage"),
...
def parse_contents(contents, filename, date, language, sentiment):
...
def update_output(list_of_contents, list_of_names, list_of_dates, language, sentiment):
    if list_of_contents is not None:
        children = [
            parse_contents(c, n, d, language, sentiment) for c, n, d in
